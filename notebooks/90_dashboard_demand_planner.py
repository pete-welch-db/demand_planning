...
# MAGIC %md
# MAGIC ## 90) Dashboard — Demand Planner View (Gold + Forecast)
# MAGIC
# MAGIC **Assumes**:
...
# MAGIC - Post-forecast KPIs refreshed (`04_post_forecast_kpis`)
# MAGIC
# MAGIC Focus:
...
# MAGIC
# MAGIC Backorders proxy uses **Silver** orders (DLT output): `silver_erp_orders`.

# COMMAND ----------
orders = spark.table(cfg.table("silver_erp_orders")).where("order_status <> 'cancelled'")
