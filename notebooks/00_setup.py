...
# MAGIC %md
# MAGIC ## 0) Setup (Azure Databricks / Lakehouse best practices)
# MAGIC
# MAGIC This notebook centralizes parameters (catalog/schema, scale) and provides helper functions used by the rest of the demo.
# MAGIC
# MAGIC **Best practices baked in**
# MAGIC - Use **Unity Catalog** objects when available (catalog + schema).
# MAGIC - Use managed **Delta tables** for synthetic data.
